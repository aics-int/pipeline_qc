...
class Structures:
    ...
    struct_map = {
        ...
        "LAMP1":    {"ml": False, "algo": "Python LAMP1 structure segmentation", "algo_version": "1.1.0"},
        ...
        "SON":      {"ml": False, "algo": "Python SON structure segmentation", "algo_version": "1.0.0"}, #TODO verify
