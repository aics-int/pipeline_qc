...
from pipeline_qc.image_qc_methods.cell_seg_wrapper_distributed3 import CellSegmentationDistributedWrapper3
...
def get_app_root(env: str) -> CellSegmentationDistributedWrapper3:
    """
    ...
    return CellSegmentationDistributedWrapper3(uploader, conf["labkey_context"])
...
def main():
    ...
    try:        
        cell_seg: CellSegmentationDistributedWrapper3 = get_app_root(args.env)
